...
data class ScientificNumber(var number: BigDecimal, var uncertainty: BigDecimal? = null) {
    ...
    fun cbrt(): ScientificNumber {
        return pow(BDMath.divide(BigDecimal("1"), BigDecimal("3")))
    }
    ...
    companion object {
         ...
         */
        fun add(
            vararg scientificNumbers: ScientificNumber,
        ...
        fun multiply(
            ...
            scientificNumbers.forEach { scientificNumber: ScientificNumber ->
                ...
                scientificNumber.uncertainty?.let {
                    newUncertainty = BDMath.add(
                        newUncertainty ?: BigDecimal("0"),
                        BDMath.pow(scientificNumber.fractionalUncertainty(), 2)
                    )
